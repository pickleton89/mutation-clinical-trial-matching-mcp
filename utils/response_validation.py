...
class TypeValidator(FieldValidator):
    ...
    def __init__(self, expected_types: Union[Type, List[Type]], required: bool = True):
...
class RangeValidator(FieldValidator):
    ...
    def __init__(self, min_value: Optional[float] = None, max_value: Optional[float] = None, required: bool = True):
...
class ArrayValidator(FieldValidator):
    ...
    def __init__(self, item_validator: Optional[FieldValidator] = None, min_length: Optional[int] = None, max_length: Optional[int] = None, required: bool = True):
...
class SchemaRegistry:
    ...
    def get_schema(self, name: str) -> Optional[ResponseSchema]:

...
class Node[T, R]:
    ...
    def post(self, shared: dict[str, Any], prep_result: T, exec_result: R) -> str | None:
        """
    ...
    def get_next_node_id(self, action: str | None = None) -> str | None:
        """
    ...
    def process(self, shared: dict[str, Any]) -> str | None:
        """
...
class Flow:
    ...
    def _auto_register_nodes(self, node: Node, visited: set | None = None):
        """
    ...
    def run(self, shared: dict[str, Any] | None = None) -> dict[str, Any]:
        """
...
class AsyncNode[T, R]:
    ...
    async def post(self, shared: dict[str, Any], prep_result: T, exec_result: R) -> str | None:
        """
    ...
    async def process(self, shared: dict[str, Any]) -> str | None:
        """
...
class AsyncFlow:
    ...
    def _auto_register_nodes(self, node: AsyncNode, visited: set | None = None):
        """

...
class AsyncSemaphoreManager:
    ...
    @staticmethod
    async def get_semaphore(service: str, custom_limit: Optional[int] = None) -> asyncio.Semaphore:
        """
    ...
    @staticmethod
    async def _create_semaphore(service: str, custom_limit: Optional[int] = None) -> asyncio.Semaphore:
        """
    ...
    @staticmethod
    async def reset_semaphore(service: str, new_limit: Optional[int] = None) -> None:
        """
...
async def get_clinicaltrials_semaphore(custom_limit: Optional[int] = None) -> asyncio.Semaphore:
    """Get the semaphore for clinicaltrials.gov API."""
    return await AsyncSemaphoreManager.get_semaphore('clinicaltrials', custom_limit)


async def get_anthropic_semaphore(custom_limit: Optional[int] = None) -> asyncio.Semaphore:
    """Get the semaphore for Anthropic API."""
    return await AsyncSemaphoreManager.get_semaphore('anthropic', custom_limit)


async def get_global_semaphore(custom_limit: Optional[int] = None) -> asyncio.Semaphore:
...
class SemaphoreContext:
    ...
    def __init__(self, service: str, operation: str, custom_limit: Optional[int] = None):
    ...
    async def __aenter__(self):
        ...
        try:
            from utils.metrics import increment, gauge

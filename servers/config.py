...
class ServerConfig:
    ...
    # Execution mode
    async_mode: bool | None = None  # None = auto-detect
...
def get_runtime_config(async_mode: bool | None = None) -> dict[str, Any]:
    """
...
def print_config_summary(config: ServerConfig | None = None) -> str:
    """

...
def send_jsonrpc_request(method, params=None, request_id=1):
    ...
    server_path = "/Users/jeffkiefer/Documents/projects/mutation_clinical_trial_matching_mcp/simple_mcp_server.py"
    ...
    response_body = process.stdout.read(content_length) if content_length > 0 else b""

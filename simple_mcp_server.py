        ...
        if method == "initialize":
            ...
            return {
                ...
                "result": {
                    ...
                    "capabilities": {"methods": ["echo", "get_manifest"]},
                },
            }
            ...
            return {
                ...
                "result": {
                    ...
                    "displayName": "Simple MCP",
                    "displayDescription": "A simple MCP server for testing connections",
...
if __name__ == "__main__":
    ...
    try:
        print("Starting Simple MCP server - using separate thread to ensure continuous operation", file=sys.stderr, flush=True)
